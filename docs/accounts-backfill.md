...
- Live monthly-URL availability must be measured rather than assumed. A 404 is reported as absent and never silently narrows the requested range; older data may require a separate Companies House archive route.
